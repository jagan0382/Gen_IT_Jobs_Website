...
@Component({
  selector: 'app-resume-building',
  templateUrl: './resume-building.component.html',
  styleUrls: ['./resume-building.component.css']
})
export class ResumeBuildingComponent implements OnInit {
...
document.getElementById('backToTop14').addEventListener('click', function () {
  window.scrollTo({
      top: 0,
      behavior: 'smooth',
  });
  ...
  steps = [
    ...
    {
      title: 'Build  <br> Your  Resume',
      description: 'Instantly get a resume for free and actionable feedback.',
